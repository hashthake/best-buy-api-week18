...
public class ProductsCRUDTest extends TestBase {
    ...
    public static String name = "Harry Porter Books"+ TestUtils.getRandomValue();
    public static String type = "Books"+TestUtils.getRandomValue();
    public static double price = 9.99;
    ...
    public static String manufacturer = "Rowling";
    public static String model = "MN2400B4Z";
    public static String url = "htt://www.bestbuy.com/site/Rowling-aaa-batteries-4-pack/43900.p?id=1051384074145&skuId=43900&cmp=RMXCC";
